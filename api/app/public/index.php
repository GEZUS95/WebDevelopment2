...
// companys
$router->post('/bedrijven', 'BedrijfController@createCompany');
$router->put('/bedrijven/(\d+)', 'BedrijfController@updateCompany'); // bedrijf
...
// recenties
$router->post('/recenties', 'RecentieController@createOne');
